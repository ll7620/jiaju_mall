...
<head>
    ...
    <%--<<base href="http://localhost:8888/home_mall/">--%>
    ...
    <script type="text/javascript">
        $(function (){
            ...
            $("#username").blur(function (){
               ...
               $.getJSON(
                   "memberServlet",
                  /* "action=isExistName&username="+username,*/
                   {
                       "action":"isExistName",
                       "username":username
                   },
                   function (date){
                       /*console.log("data=",date.isExist);*/
                       if(date.isExist){
            ...
            $("#codeImg").click(function (){
                ...
                this.src="http://localhost:8888/home_mall/kaptchaServlet?d="+new Date();
            })
                ...
                <div class="login-register-wrapper">
                    ...
                    <div class="tab-content">
                        <div id="lg1" class="tab-pane active">
                            <div class="login-form-container">
                                <div class="login-register-form">
                                    ...
                                    <span style="font-size: 18pt; font-weight: bold;float: right">
                                        ${requestScope.msg}
                                    </span>
                        ...
                        <div id="lg2" class="tab-pane">
                            <div class="login-form-container">
                                <div class="login-register-form">
                                          <span class="errorMsg" style="font-size: 18pt; font-weight: bold;float: right">
                                              ${requestScope.msg}
                                          </span>
                                    <form action="memberServlet" method="post">
                                        ...
                                        <input type="password" id="repwd" name="userpassword" placeholder="确认密码"/>
