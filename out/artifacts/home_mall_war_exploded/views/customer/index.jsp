            ...
            <div class="row align-self-center">
                ...
                <div class="col align-self-center">
                    <div class="header-actions">
                        ...
                        <!-- Single Wedge End href="#offcanvas-cart"-->
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            ...
                                            <button title="AddToCart" class="add-to-cart" furnId="${furn.id}">Add
                                                To Cart
                                            </button>
                                        </div>
                                        <div class="content">
                                            ...
                                            <span class="price">
                                                <span class="new">家局：${furn.name}</span>
                                            </span>
                                            <span class="price">
...
<div class="pro-pagination-style text-center mb-md-30px mb-lm-30px mt-6" data-aos="fade-up">
    <ul>
        ...
        <c:if test="${requestScope.page.pageNo > 1}">
            <%--<li><a href="customerServlet?action=page&pageNo=${requestScope.page.pageNo - 1}">上页</a></li>--%>
        ...
        <li><a>共${requestScope.page.totalRow}条记录</a></li>
    </ul>
</div>
<!--  Pagination Area End -->
